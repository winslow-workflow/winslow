...
class ComposedStorage(BaseStorage):
    ...
    def __init__(self, storage_classes, cache_name, namespace):
        super().__init__(cache_name, namespace)
        self._tiers = [kls(cache_name, namespace) for kls in storage_classes]
        self._writable = [
...
def compose(*storage_classes):
    ...
    return partial(ComposedStorage, storage_classes)
